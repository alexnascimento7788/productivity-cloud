          ...
          <div className="absolute bottom-full left-2 right-2 mb-1 bg-bg-primary border border-border-color rounded-xl shadow-xl z-50 flex flex-col max-h-[70vh]">
            ...
            <div className="px-4 py-4 border-b border-border-color">
              ...
              <ul className="space-y-2 text-xs text-text-secondary">
                <li className="flex gap-2">
                  <span className="text-accent-green mt-0.5 flex-shrink-0">✓</span>
                  <span><span className="text-text-primary font-medium">Correção:</span> no mapa (modo agrupado por equipe+cidade), passar o mouse rápido por equipes próximas fazia o popup piscar e o mapa saltar para o meio do oceano Atlântico. O hover não move mais a câmera do mapa, e o card fecha ao tirar o mouse de cima</span>
                </li>
              </ul>
            </div>
            ...
            {/* Versão 4.9.2 */}
            <div className="px-4 py-4 border-b border-border-color">
              <p className="text-xs font-semibold text-accent-blue mb-3">Versão Cloud 4.9.2</p>
              <ul className="space-y-2 text-xs text-text-secondary">
                <li className="flex gap-2">
                  <span className="text-accent-green mt-0.5 flex-shrink-0">✓</span>
                  <span><span className="text-text-primary font-medium">Painel Master:</span> "Apagar base", "Excluir empresa" e "Excluir usuário" agora mostram uma confirmação em tela quando a ação termina com sucesso</span>
                </li>
              </ul>
            </div>
